...
void __stdcall WinHttpAddRequestHeaders(int p0, int p1, int p2, int p3) {}
void __stdcall WinHttpAddRequestHeadersEx(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7) {}
void __stdcall WinHttpCheckPlatform() {}
void __stdcall WinHttpCloseHandle(int p0) {}
void __stdcall WinHttpConnect(int p0, int p1, int p2, int p3) {}
void __stdcall WinHttpCrackUrl(int p0, int p1, int p2, int p3) {}
void __stdcall WinHttpCreateProxyResolver(int p0, int p1) {}
void __stdcall WinHttpCreateUrl(int p0, int p1, int p2, int p3) {}
void __stdcall WinHttpDetectAutoProxyConfigUrl(int p0, int p1) {}
...
void __stdcall WinHttpGetProxyForUrl(int p0, int p1, int p2, int p3) {}
void __stdcall WinHttpGetProxyForUrlEx(int p0, int p1, int p2, int p3) {}
...
void __stdcall WinHttpQueryHeaders(int p0, int p1, int p2, int p3, int p4, int p5) {}
void __stdcall WinHttpQueryHeadersEx(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9, int p10) {}
void __stdcall WinHttpQueryOption(int p0, int p1, int p2, int p3) {}
void __stdcall WinHttpReadData(int p0, int p1, int p2, int p3) {}
...
void __stdcall WinHttpSetDefaultProxyConfiguration(int p0) {}
void __stdcall WinHttpSetOption(int p0, int p1, int p2, int p3) {}
void __stdcall WinHttpSetProxySettingsPerUser(int p0) {}
void __stdcall WinHttpSetStatusCallback(int p0, int p1, int p2, int p3) {}
...
void __stdcall WinHttpWebSocketReceive(int p0, int p1, int p2, int p3, int p4) {}
void __stdcall WinHttpWebSocketSend(int p0, int p1, int p2, int p3) {}
void __stdcall WinHttpWebSocketShutdown(int p0, int p1, int p2, int p3) {}
void __stdcall WinHttpWriteData(int p0, int p1, int p2, int p3) {}
void __stdcall WinHttpWriteProxySettings(int p0, int p1, int p2) {}
