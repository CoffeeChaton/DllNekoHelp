...
void __stdcall BCryptDeriveKeyCapi(int p0, int p1, int p2, int p3, int p4) {}
void __stdcall BCryptDeriveKeyPBKDF2(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9) {}
void __stdcall BCryptDestroyHash(int p0) {}
void __stdcall BCryptDestroyKey(int p0) {}
...
void __stdcall BCryptEnumContextFunctions(int p0, int p1, int p2, int p3, int p4) {}
void __stdcall BCryptEnumContexts(int p0, int p1, int p2) {}
void __stdcall BCryptEnumProviders(int p0, int p1, int p2, int p3) {}
void __stdcall BCryptEnumRegisteredProviders(int p0, int p1) {}
void __stdcall BCryptExportKey(int p0, int p1, int p2, int p3, int p4, int p5, int p6) {}
void __stdcall BCryptFinalizeKeyPair(int p0, int p1) {}
void __stdcall BCryptFinishHash(int p0, int p1, int p2, int p3) {}
void __stdcall BCryptFreeBuffer(int p0) {}
void __stdcall BCryptGenRandom(int p0, int p1, int p2, int p3) {}
void __stdcall BCryptGenerateKeyPair(int p0, int p1, int p2, int p3) {}
void __stdcall BCryptGenerateSymmetricKey(int p0, int p1, int p2, int p3, int p4, int p5, int p6) {}
void __stdcall BCryptGetFipsAlgorithmMode(int p0) {}
void __stdcall BCryptGetProperty(int p0, int p1, int p2, int p3, int p4, int p5) {}
void __stdcall BCryptHash(int p0, int p1, int p2, int p3, int p4, int p5, int p6) {}
void __stdcall BCryptHashData(int p0, int p1, int p2, int p3) {}
void __stdcall BCryptImportKey(int p0, int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8) {}
void __stdcall BCryptImportKeyPair(int p0, int p1, int p2, int p3, int p4, int p5, int p6) {}
void __stdcall BCryptKeyDerivation(int p0, int p1, int p2, int p3, int p4, int p5) {}
void __stdcall BCryptOpenAlgorithmProvider(int p0, int p1, int p2, int p3) {}
void __stdcall BCryptProcessMultiOperations(int p0, int p1, int p2, int p3, int p4) {}
void __stdcall BCryptQueryContextConfiguration(int p0, int p1, int p2, int p3) {}
void __stdcall BCryptQueryContextFunctionConfiguration(int p0, int p1, int p2, int p3, int p4, int p5) {}
